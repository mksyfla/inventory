...
export const MOCK_CATEGORIES: ItemCategory[] = [
  { id: 1, name: 'Bahan Baku Cetak' },
  { id: 2, name: 'Tinta & Kimia Pemroses' },
  { id: 3, name: 'Kertas Dokumen Sekuriti' },
  { id: 4, name: 'Komponen Mesin & Sparepart' },
  { id: 5, name: 'Perlengkapan Kemasan' },
];
